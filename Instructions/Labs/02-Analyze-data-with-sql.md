...
> **注**: **sales** フォルダーを作成し、**csv**、**json**、および **parquet** のフォルダーを **sales** フォルダーの下に作成することが必要になる場合があります。 これが完了すれば、ローカル コンピューターの覚えておいたフォルダーにファイルをダウンロードし、上記で作成した適切なフォルダーに基づいて、それぞれ適切なフォルダーにファイルをアップロードできます。
> ファイルは次のパスからダウンロードできます: https://github.com/MicrosoftLearning/dp-203-azure-data-engineer/tree/master/Allfiles/labs/02/data
