...
5. **[作業の開始]** ペインで、 **[SQL Warehouse の確認]** を選択します (または、サイド バーで **[SQL Warehouse]** を選択します)。
6. ワークスペースに **Starter Warehouse** という名前の SQL ウェアハウスが既に含まれていることを確認します。
7. その SQL ウェアハウスの **[アクション]** ( **&#8285;** ) メニューで、 **[編集]** を選択します。 次に、 **[クラスター サイズ]** プロパティを **[2X-Small]** に設定し、変更を保存します。
