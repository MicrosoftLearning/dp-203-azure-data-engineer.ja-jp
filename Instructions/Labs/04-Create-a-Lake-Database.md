...
1. **files フォルダー**内では、 **[認証方法:]** が ***[アクセス キー (Azure AD ユーザー アカウントに切り替え)]*** として一覧に表示されます。これをクリックして Azure AD ユーザー アカウントに変更します。
...
1. Synapse ワークスペースを選び、その **[概要]** ページの **[Synapse Studio を開く]** カードで **[開く]** を選んで、新しいブラウザー タブで Synapse Studio を開きます。ダイアログが表示されたらサインインします。
